...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-white pt-10 sm:pt-16 pb-8 sm:pb-10"> {/* Adjusted padding */}
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 sm:gap-y-12 mb-10 sm:mb-12"> {/* Adjusted gaps */}
          ...
          <div>
            <h4 className="font-bold text-md mb-4 sm:mb-5">Apa itu Aksess</h4> {/* Adjusted margin-bottom */}
            <ul className="space-y-2.5 sm:space-y-3"> {/* Adjusted spacing */}
          ...
          <div>
            <h4 className="font-bold text-md mb-4 sm:mb-5">Tentang Event</h4>
          ...
          {/* Column 4: Follow us */}
          <div>
            <h4 className="font-bold text-md mb-4 sm:mb-5">Follow us</h4>
            <div className="space-y-3 sm:space-y-3.5"> {/* Adjusted spacing */}
              <div className="flex space-x-4 sm:space-x-5"> {/* Adjusted icon spacing */}
                <a href="#" aria-label="Instagram" className="hover:text-purple-300 transition-colors">
                  <Instagram size={22} /> {/* Slightly larger icons */}
                </a>
                <a href="#" aria-label="Facebook" className="hover:text-purple-300 transition-_colors">
                  <Facebook size={22} />
                </a>
        ...
        <hr className="border-slate-700 opacity-50 my-8 sm:my-10" /> {/* Adjusted color and margin */}
