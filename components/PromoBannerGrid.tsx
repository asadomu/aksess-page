...
export default function PromoBannerGrid({ banners }: PromoBannerGridProps) {
  ...
  if (!bigBanner || mediumBanners.length < 2) {
    ...
    return (
      <section className="py-8 sm:py-10 md:py-16 bg-gray-50"> {/* Adjusted vertical padding */}
  ...
  return (
    <section className="py-8 sm:py-10 md:py-16 bg-gray-50"> {/* Adjusted vertical padding */}
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-start"> {/* Adjusted gap */}
          ...
          <div className="md:col-span-2 grid grid-cols-1 gap-4 sm:gap-6 md:gap-8"> {/* Adjusted gap */}
