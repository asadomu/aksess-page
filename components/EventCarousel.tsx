...
export default function EventCarousel({ title, events }: EventCarouselProps) {
  return (
    <section className="py-8 sm:py-10 md:py-16 bg-white"> {/* Adjusted vertical padding */}
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8 md:mb-10">{title}</h2> {/* Adjusted bottom margin */}
        <div 
          className="flex overflow-x-auto space-x-4 sm:space-x-5 md:space-x-8 pb-6 -mb-6 no-scrollbar snap-x snap-mandatory" // Adjusted spacing
          role="list"
          aria-label={title}
        >
